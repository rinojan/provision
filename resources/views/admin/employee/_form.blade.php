<div class ="row">
    ...
    <div class="col-md-4">  {!! Form::text ('working_duration','Working Duration')->type('number')->value(1) !!}</div>
...
////////////////////////////////////////////////////////////////////////////
        ...
        @if(isset($employee))
            ...
            $('#job_category_id').val("{{$employee->job_category_id}}");
            $('#job_id').val("{{$employee->job_id}}");

            var jobCategories ="{{$employee->job_category_id}}" ;
            var job ="{{$employee->job_id}}" ;

            jobcategoryChange(jobCategories,job);
